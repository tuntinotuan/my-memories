...
const TypingOverlayBlur = ({ htmlFor }: { htmlFor: string }) => {
  ...
  return (
    <label
      ...
      tabIndex={0}
      htmlFor={htmlFor}
      className={`absolute left-0 right-0 bottom-0 h-96 flex items-start justify-center gap-3 bg-[#262A33] bg-opacity-20 backdrop-blur-[9px] cursor-pointer transition-all focus:border-none z-20 pt-16 ${
