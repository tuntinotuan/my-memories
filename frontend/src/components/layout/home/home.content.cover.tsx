...
const HomeContentCover = ({ children, className }: HomeContentCoverProps) => {
  ...
  return (
    <div className="relative bg-white rounded-t-xl shadow-[0_0_12px_2px_rgba(0,0,0,0.2)] border border-gray-300 w-full h-full overflow-hidden">
      <HomeMenuHeader scroll={scroll}></HomeMenuHeader>
      <div
        className={`relative w-full flex-1 h-[92%] flex overflow-x-hidden ${className}`}
        ref={ref}
