  ...
  return (
    <div
      className={`relative shadow-md text-sm transition-all shrink-0 overflow-hidden pb-10 ${
        showMenuboard
          ? "h-full w-[300px] border border-gray-200 border-r-transparent dark:border-darkMode0A dark:border-r-transparent opacity-100 px-2 py-3 "
...
const Body = ({ page }: PageProps) => {
  return (
    <div className="h-full overflow-auto border border-transparent border-t-gray-200 dark:border-t-darkMode0A pb-2">
      {page === "menu" && <BoardMenu />}
