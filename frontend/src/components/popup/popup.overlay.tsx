...
const LocalOverlay = ({
  ...
  return (
    ...
    >
      ...
      ></div>
      <div
        className={`fixed mx-auto top-[10vh] left-0 right-0 z-[9999] h-auto max-h-[88vh] border border-gray-200 rounded-md shadow-2xl text-xs transition-all bg-efColor flex flex-col items-center p-4 ${
          show
